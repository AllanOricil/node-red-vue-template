  ...
  <div>
    <div class="form-row">
      <span class="nrg-label"
        ><i class="fa fa-tag"></i> {{ $i18n("configs.name") }}</span
      >
    ...
    <div class="form-row">
      <span class="nrg-label"
        ><i class="fa fa-tag"></i> {{ $i18n("credentials.username") }}</span
      >
      <NodeRedInput
    ...
    <div class="form-row">
      <span class="nrg-label"
        ><i class="fa fa-tag"></i> {{ $i18n("credentials.password") }}</span
      >
      <NodeRedInput
    ...
    <div class="form-row">
      <span class="nrg-label"
        ><i class="fa fa-tag"></i> {{ $i18n("credentials.password2") }}</span
      >
      <NodeRedInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.myProperty") }}</span>
      <NodeRedTypedInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.myProperty2") }}</span>
      <NodeRedTypedInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.remoteServer") }}</span>
      <NodeRedConfigInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.anotherRemoteServer") }}</span>
      <NodeRedConfigInput
        v-model:value="node.anotherRemoteServer"
        type="remote-server"
        :node="node"
        prop-name="anotherRemoteServer"
        :error="errors['node.anotherRemoteServer']"
      />
    </div>

    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.country") }}</span>
      <NodeRedSelectInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.fruit") }}</span>
      <NodeRedSelectInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.number") }}</span>
      <NodeRedSelectInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.object") }}</span>
      <NodeRedSelectInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.array") }}</span>
      <NodeRedSelectInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.jsontest") }}</span>
      <NodeRedEditorInput
    ...
    <div class="form-row">
      <span class="nrg-label">{{ $i18n("configs.csstest") }}</span>
      <NodeRedEditorInput
